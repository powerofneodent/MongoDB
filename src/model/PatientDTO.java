...
public class PatientDTO {
	...
	@Override
	public int hashCode() {
		return Objects.hash(addres, alergy, birthDate, dniNie, email, habit, id, localityId, localityName, name,
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(addres, other.addres) && Objects.equals(alergy, other.alergy)
				&& Objects.equals(birthDate, other.birthDate) && Objects.equals(dniNie, other.dniNie)
	...
	public String toString() {
		return "PatientDTO [id=" + id + ", name=" + name + ", surname1=" + surname1 + ", surname2=" + surname2
				...
				+ localityId + ", localityName=" + localityName + "]";
	}
